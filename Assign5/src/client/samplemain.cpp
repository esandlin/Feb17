   ...
   void Menu_Clicked() {
      ...
      if(selectPath.compare("File/Save")==0){
         ...
         exit(0);
           ...
           cout << "Album not implemented" << endl;
        ...
        }else if(selectPath.compare("Album/Play")==0){
...
int main(int argc, char * argv[]) {
   std::string developer = (argc>1)?argv[1]:"Eric.Sandlin";
   ...
   albumscollectionstub sc(httpclient);
